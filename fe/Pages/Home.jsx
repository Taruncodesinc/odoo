...
function Landing() {
  ...
  const tagOptions = ["Road", "Garbage", "StreetLight", "Construction", "Park", "Water Supply"];
    ...
    const data = [
      {
        ...
        tags: ["Road"],
        status: "Unresolved",
        description: "The road has multiple potholes and cracks, making it dangerous for vehicles and pedestrians.",
      },
      {
        id: 2,
        ...
        status: "Resolved",
        tags: ["Garbage"],
        description: "The garbage bin is constantly overflowing, leading to foul smell and health concerns.",
      },
      // ... add more dummy issues if needed
    ];
    setIssues(data);
  };
          ...
          {Array.from({ length: totalPages }, (_, idx) => idx + 1).map((num) => (
            <button
              ...
              className={`px-3 py-1 rounded-md ${
                num === currentPage ? 'bg-blue-600 text-white' : 'bg-white hover:bg-gray-200'
              }`}
            >
              {num}
            </button>
